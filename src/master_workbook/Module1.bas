...
' Private Const USEREDITSLOG_SHEET_NAME As String = "UserEditsLog" ' Not used in Master
...
'===============================================================================
' MODULE1 (Master Workbook Dashboard Logic)
' Contains functions for managing the SQRCT Dashboard in the Master workbook.
' Refactored for performance (Dictionary lookup), security (no passwords), and robustness (constants).
' Note: Logging and Backup functions are omitted as they were not present in the original Master module.
...
Public Sub RefreshDashboard(Optional PreserveUserEdits As Boolean = False)
    ...
    ' Note: Backup creation/logging omitted as per original Master module structure
    ...
    For i = 4 To lastRow
        ...
        If docNum <> "" And docNum <> "Document Number" Then
            ...
            Else
                 ' Clear existing user data if no match found in UserEdits (optional)
    ...
    ' Note: Logging and backup cleanup omitted as per original Master module structure
...
ErrorHandler:
    ...
    MsgBox "An error occurred during dashboard refresh." & _
           vbCrLf & "Error: " & Err.Description, vbCritical, "Dashboard Refresh Error"
    ' Note: Backup restore omitted
    Resume Cleanup
End Sub
    ...
    For i = 4 To lastRowSrc
        ...
        If docNum <> "" And docNum <> "Document Number" Then
            ...
            If hasUserEdits Or editRow > 0 Then
                ...
                ' Set ChangeSource to "MASTER" and update timestamp only if something changed
...
ErrorHandler:
    ' Note: Logging omitted
    ' Resume NextIteration ' Removed GoTo
            ...
            If lastRow > 1 Then
                ...
                For i = 2 To lastRow
                    ...
                    If wsBackup.Cells(i, 1).Value <> "" Then
                        ...
                        wsEdits.Cells(i, UE_COL_SOURCE).Value = MASTER_ATTRIBUTION ' Use Master constant
