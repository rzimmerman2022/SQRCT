        ...
        If docNum <> "" And docNum <> "Document Number" Then
            ...
            If hasUserEdits Or foundRow > 0 Then
                ...
                If hasUserEdits And wasChanged Then
                    wsEdits.Cells(destRow, "F").Value = "MASTER"  ' Master file identifier
            ...
            If lastRow > 1 Then
                ...
                For i = 2 To lastRow
                    ...
                    If wsBackup.Cells(i, 1).Value <> "" Then
                        ...
                        wsEdits.Cells(i, "F").Value = "MASTER"  ' Set as master source
...
'===============================================================================
' Clean up duplicate rows while preserving the core structure
'===============================================================================
